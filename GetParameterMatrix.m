function [BoundMatrix] = GetParameterMatrix()
    ...
    % 3.  Max Euler Number/100( Value > 1 and Value < 1 )/100                  
    ...
    % 22. Max Average Euler Number for aligned/100 ( 0 < Value < 1)
    % 23. Min Average Euler Number for aligned/100 ( 0 < Value < Max Euler)
    ...
    BoundMatrix = [zeros(1,39);ones(1,39)];   
